...
function Contacto() {
  ...
  const handleSubmit = (event) => {
    ...
    alert(`Gracias por tu mensaje, ${nombre}. Nos pondremos en contacto pronto (Simulación).`);
  ...
  return (
    <div className="container py-5">
      ...
      <div className="row g-5"> {/* g-5 para más espacio entre columnas */}
        ...
        <div className="col-md-6">
          ...
          <h4 className="mt-5 mb-4">Nuestras Tiendas</h4>
           {/* Podrías integrar un mapa real aquí si quieres */}
          <div className="card">
