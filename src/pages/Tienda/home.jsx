...
import { products } from '../../data/products'; // Importa todos los productos
import ProductCard from '../../components/store/ProductCard'; // Tarjeta de producto

function Home() {
  const [featuredProducts, setFeaturedProducts] = useState([]);

  useEffect(() => {
    // Selecciona 4 productos al azar para mostrar como destacados
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="hero-section text-white text-center py-5 mb-5" style={{
      ...
      <section className="py-5 bg-pattern"> {/* bg-pattern definido en index.css si es necesario */}
